...
class AboutLalkila extends StatefulWidget {
  const AboutLalkila({super.key});

  @override
  State<AboutLalkila> createState() => _AboutLalkilaState();
}

class _AboutLalkilaState extends State<AboutLalkila> {
  @override
...
//____________________________________Image Section_______________________________________________
            Image.asset('lib/assets/images/Lalkila1.png'),
